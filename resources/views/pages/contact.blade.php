    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img style="display: block;margin-left: auto; margin-right: auto;" class="banerr" src="/view/{{ $banercontact->gambar }}" alt="Image">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">Drajat, Paciran, Lamongan</h4>
                        </div>
                    </div>
                </div>
            </div>
